...
if(isset($_POST['submitted'])) {
    ...
    if(!isset($hasError)) {
        ...
        $subject = __('From ','jediwp').$name;
        $body = __('Name: ','jediwp').$name."\n".__('Email: ','jediwp').$email."\n".__('Comments: ','jediwp').$comments;
        $headers = __('From: ','jediwp') .$name. ' <'.$emailTo.'>' . "\r\n" . __('Reply-To:','jediwp') .$name. '<'.$email.'>';
						...
						<?php the_content(); ?>
				          ...
				          <?php if(isset($emailSent) && $emailSent == true) { ?>
				                <div class="alert alert-success" role="alert">
				                    <p><?php _e('Thanks, your email was sent successfully.', 'jediwp'); ?></p>
				                </div>
				            <?php } else { ?>
				                ...
				                <?php if(isset($hasError) || isset($captchaError)) { ?>
				                    <div class="alert alert-danger alert-dismissible" role="alert">
									  ...
									  <strong><?php _e('Error!', 'jediwp'); ?></strong> <?php _e('Please try again.', 'jediwp'); ?>
									</div>
				                <?php } ?>

						        <form action="<?php the_permalink(); ?>" id="contactForm" method="post">
						            <div class="form-group <?php if(isset($nameError)) { echo "has-error has-feedback"; }?>">
						                    <label class="control-label" for="contactName"><?php _e('Name', 'jediwp'); ?></label>
						               ...
						               <div class="form-group <?php if(isset($emailError)) { echo "has-error has-feedback"; }?>">
						                    <label class="control-label" for="email"><?php _e('Email', 'jediwp'); ?></label>
						                ...
						                <div class="form-group <?php if(isset($commentError)) { echo "has-error has-feedback"; }?>">
						                    <label class="control-label" for="commentsText"><?php _e('Message', 'jediwp'); ?></label>
						               ...
						               <div class="form-actions">
						                    <button type="submit" class="btn btn-primary"><?php _e('Send Email', 'jediwp'); ?></button>
